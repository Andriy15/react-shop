      ...
      >
        ...
        <div className='flex'>
          <p className="text-gray-500 text-sm mt-2 mr-4">
            <a rel="noreferrer" href='https://github.com/Andriy15' target='_blank'><img src="https://img.icons8.com/external-those-icons-flat-those-icons/24/null/external-GitHub-Logo-social-media-those-icons-flat-those-icons-2.png"/></a>
          </p>
          <p className="text-gray-500 text-sm mt-2 mr-4"> 
            <a rel="noreferrer" href="https://twitter.com/AndrijCikulaj" target='_blank'><img src="https://img.icons8.com/material-sharp/24/null/twitter.png"/></a>
          </p>
          <p className="text-gray-500 text-sm mt-2">
            <a rel="noreferrer" href="https://www.linkedin.com/in/%D0%B0%D0%BD%D0%B4%D1%80%D1%96%D0%B9-%D1%87%D0%B8%D0%BA%D1%83%D0%BB%D0%B0%D0%B9-2a686723b/?originalSubdomain=ua" target='_blank'><img src="https://img.icons8.com/material-sharp/24/null/linkedin.png"/></a>
            </p>  
        </div>
